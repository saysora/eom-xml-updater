/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db04d8292bac44ba1bb0ed047897414c)
...
declare namespace Cloudflare {
	...
	interface Env {
		XML_URLS: ["https://feeds.feedburner.com/cccm/KEwU","https://feeds.feedburner.com/cccm/MZFU","https://feeds.feedburner.com/WomenYouShouldKnow"];
		DB_URL: string;
		XML_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XML_URLS" | "DB_URL" | "XML_URL">> {}
}
